 ...
 *
 *
 *  Author:  David Harris wrote levin.  Mike Firpo copied levin to levinD
 *	     and changed r to double precision.
 *
 *  Last Modified:  	October 15, 1999. Made r double precision.
 *			July 23, 1996.	added casting operations to 
